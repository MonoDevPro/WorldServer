...
namespace Simulation.Application.Services.Publisher;

public sealed partial class SnapshotForwarding : BaseSystem<World, float>, ICharSnapshotPublisher, IMapSnapshotPublisher
{
    ...
    // Persistant data
    [Event]
    public void Publish(CharSaveTemplate s) => _charPublisher.Publish(s);

    
    public SnapshotForwarding(World world, ICharSnapshotPublisher charPublisher, IMapSnapshotPublisher mapPublisher, ILogger<SnapshotForwarding> logger) : base(world)
    {
